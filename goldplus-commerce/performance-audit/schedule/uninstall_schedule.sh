...
systemctl disable --now goldplus-performance-audit.timer 2>/dev/null || true
rm -f /etc/systemd/system/goldplus-performance-audit.timer /etc/systemd/system/goldplus-performance-audit.service
