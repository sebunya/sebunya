...
const READ_ONLY_SET: readonly Permission[] = [
  ...
  P.ANALYTICS_READ, P.MEDIA_READ, P.LEGAL_READ, P.DELIVERY_CONFIG_READ, P.SEO_VIEW, P.BATTERIES_READ,
...
export const ROLE_PERMISSION_BASELINES: Record<GovernanceRole, readonly Permission[]> = {
  ...
  ANALYST: [
    ...
    P.CUSTOMER_DNA_READ, P.NBA_READ, P.DECISION_INTELLIGENCE_READ, P.EXPERIMENTS_READ, P.SURVEYS_READ, P.SEO_VIEW,
    P.ORDERS_READ, P.PAYMENTS_READ, P.PRODUCTS_READ, P.INVENTORY_READ, P.PRICING_READ, P.PROMOTIONS_READ,
    P.RECOMMENDATIONS_READ, P.BATTERIES_READ, P.COPY_QUALITY_READ,
  ],
  SUPPORT_OPERATOR: [
