...
const runSeed = async () => {
  ...
  await db.insert(schema.productPrices).values([
    { productId: productId1, retailPrice: 50000 },
    { productId: productId2, retailPrice: 80000 },
    { productId: productId3, retailPrice: 25000 },
    { productId: productId4, retailPrice: 120000 },
    { productId: productId5, retailPrice: 150000 },
    { productId: productId6, retailPrice: 35000 },
    { productId: productId7, retailPrice: 60000 },
    { productId: productId8, retailPrice: 110000 }
  ]).onConflictDoNothing();
