...
const runSeed = async () => {
  ...
  await db.insert(schema.productPrices).values([
    { productId: productId1, retailPrice: 145000 },
    { productId: productId2, retailPrice: 145000 },
    { productId: productId3, retailPrice: 145000 },
    { productId: productId4, retailPrice: 145000 },
    { productId: productId5, retailPrice: 145000 },
    { productId: productId6, retailPrice: 145000 },
    { productId: productId7, retailPrice: 145000 },
    { productId: productId8, retailPrice: 145000 }
  ]).onConflictDoNothing();
