...
# standalone runs.
for m in 0099_recommendation_event_contract 0100_experience_profiles 0101_order_profile_stitching 0102_commercial_costs 0103_refund_ledger 0104_product_cost_entries 0105_commercial_indexes; do
