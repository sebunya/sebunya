...
export const PAYMENTS_OPS_CONFIG_REGISTRY: readonly PaymentsOpsConfigEntry[] = [
  ...
  {
    key: 'synthetic_probe_interval_hours',
    type: 'integer',
    unit: 'hours',
    min: 1,
    max: 720,
    label: 'How often to probe the payment path',
    help: 'Creates a real Pesapal transaction (then abandons it, costing nothing) to prove credentials, submit, the payment page and IPN reachability unattended. The PIN step needs a real wallet and stays unproven by design. Unset means no probe.',
  },
  {
    key: 'synthetic_probe_amount_ugx',
    type: 'integer',
    unit: 'UGX',
    min: 100,
    max: 1_000_000,
    label: 'The probe amount',
