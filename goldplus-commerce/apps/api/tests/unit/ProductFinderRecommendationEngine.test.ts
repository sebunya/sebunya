...
import { ProductFinderRecommendationEngine, ProductFinderCatalogItem } from '../../src/application/services/product-finder/ProductFinderRecommendationEngine';

describe('ProductFinderRecommendationEngine', () => {
  const catalog: ProductFinderCatalogItem[] = [
    {
      productId: 'p1', sku: 'PWR-01', name: 'Fast Power Bank 10000mAh', categoryId: 'c1', categoryName: 'Power', subcategory: 'powerbank', priceUgx: 60000, stockStatus: 'in_stock', imageUrl: '',
      features: ['fast charging', 'portable']
    },
    {
      productId: 'p2', sku: 'PWR-02', name: 'Premium Power Bank 20000mAh', categoryId: 'c1', categoryName: 'Power', subcategory: 'powerbank', priceUgx: 160000, stockStatus: 'in_stock', imageUrl: '',
      features: ['high capacity', 'fast charging']
    },
    {
      productId: 'p3', sku: 'STG-01', name: 'Flash Drive 64GB', categoryId: 'c2', categoryName: 'Storage', subcategory: 'flash', priceUgx: 30000, stockStatus: 'in_stock', imageUrl: '',
      features: ['compact', 'durable']
    },
    {
      productId: 'p4', sku: 'PWR-OUT', name: 'Out of Stock Power', categoryId: 'c1', categoryName: 'Power', subcategory: 'powerbank', priceUgx: 50000, stockStatus: 'out_of_stock', imageUrl: '',
  ...
  it('ranks by category fit and problem fit', () => {
    ...
    expect(res.recommendedProducts.find(r => r.productId === 'p4')).toBeUndefined();
  });
