...
- Reference capacity/voltage is the ORIGINAL pack's rating (27 checked against listings, the rest from public specs or the BL-code convention) — never to be shown as the GoldPlus pack's own rating until read from the pack.
