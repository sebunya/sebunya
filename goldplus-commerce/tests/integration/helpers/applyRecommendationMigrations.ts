 ...
 */
const MIGRATIONS = ["0099_recommendation_event_contract.sql", "0100_experience_profiles.sql", "0101_order_profile_stitching.sql", "0102_commercial_costs.sql", "0103_refund_ledger.sql", "0104_product_cost_entries.sql", "0105_commercial_indexes.sql", "0106_account_recovery_and_social_identity.sql"];
