...
--
-- Name: audit_logs_reject_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.audit_logs_reject_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  RAISE EXCEPTION
...
--
-- Name: loyalty_control_totals_reject_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.loyalty_control_totals_reject_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  RAISE EXCEPTION
...
--
-- Name: loyalty_ledger_reject_mutation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.loyalty_ledger_reject_mutation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  RAISE EXCEPTION
...
--
-- Name: address_audit; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.address_audit (
...
CREATE TABLE public.addresses (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    area_slug character varying(160),
    area_group_id uuid,
    landmark_text text,
    ...
    gps_accuracy_m real,
    gps_source character varying(20),
    gps_captured_at timestamp with time zone,
    raw_address_text text,
    resolution_status character varying(20) DEFAULT 'resolved'::character varying NOT NULL,
    delivery_method character varying(20) DEFAULT 'door'::character varying NOT NULL,
    pickup_point_id uuid,
    snapshot_area_label character varying(220),
    snapshot_district character varying(100),
    snapshot_postcode character varying(8),
    snapshot_data_version integer,
...
CREATE TABLE public.analytics_alert_rules (
    ...
    evaluation_days integer DEFAULT 7 NOT NULL,
    ...
    CONSTRAINT analytics_alert_rules_comparison_check CHECK (((comparison)::text = ANY ((ARRAY['ABOVE'::character varying, 'BELOW'::character varying])::text[]))),
    CONSTRAINT analytics_alert_rules_cooldown_check CHECK ((cooldown_minutes >= 0)),
    CONSTRAINT analytics_alert_rules_evaluation_days_check CHECK (((evaluation_days >= 1) AND (evaluation_days <= 366))),
    CONSTRAINT analytics_alert_rules_minimum_sample_check CHECK ((minimum_sample >= 1)),
    CONSTRAINT analytics_alert_rules_severity_check CHECK (((severity)::text = ANY ((ARRAY['CRITICAL'::character varying, 'HIGH'::character varying, 'MEDIUM'::character varying, 'LOW'::character varying])::text[])))
);


--
-- Name: analytics_saved_views; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.analytics_saved_views (
    ...
    end_day character varying(10),
    metric_keys jsonb DEFAULT '[]'::jsonb NOT NULL,
    filters jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT analytics_saved_views_period_check CHECK (((period_days IS NULL) OR ((period_days >= 1) AND (period_days <= 366)))),
    CONSTRAINT analytics_saved_views_scope_check CHECK (((scope)::text = ANY ((ARRAY['PRIVATE'::character varying, 'SHARED'::character varying])::text[]))),
    CONSTRAINT analytics_saved_views_window_check CHECK (((period_days IS NOT NULL) OR ((start_day IS NOT NULL) AND (end_day IS NOT NULL))))
);
...
--
-- Name: auth_identity_links; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.auth_identity_links (
    ...
    provider_phone_e164 character varying(20),
    provider_phone_verified boolean DEFAULT false NOT NULL,
...
--
-- Name: auth_oauth_states; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.auth_oauth_states (
    ...
    intent character varying(16) DEFAULT 'signin'::character varying NOT NULL,
    code_verifier_hash character varying(64),
    nonce_hash character varying(64),
    redirect_after character varying(255),
...
--
-- Name: auth_provider_configs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.auth_provider_configs (
    ...
    encryption_iv character varying(100) NOT NULL,
    encryption_tag character varying(100) NOT NULL,
    encryption_version integer DEFAULT 1 NOT NULL,
    config_fingerprint character varying(64),
    last_validated_at timestamp with time zone,
    last_validation_status character varying(32),
    last_validation_reason character varying(100),
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.auth_sessions (
    ...
    CONSTRAINT auth_sessions_refresh_hash_len CHECK ((char_length((refresh_hash)::text) = 64))
);


--
-- Name: auth_signin_tokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.auth_signin_tokens (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    channel character varying(16) NOT NULL,
    destination_hash character varying(64) NOT NULL,
    destination_normalized_hint character varying(80),
    token_hash character varying(64) NOT NULL,
    purpose character varying(24) NOT NULL,
    audience character varying(16) NOT NULL,
    expires_at timestamp with time zone NOT NULL,
    consumed_at timestamp with time zone,
    requested_ip_hash character varying(64),
    requested_user_agent_hash character varying(64),
    created_at timestamp with time zone DEFAULT now() NOT NULL
);


--
-- Name: auth_signup_risk_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.auth_signup_risk_events (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    audience character varying(16) NOT NULL,
    event_type character varying(40) NOT NULL,
    risk_score integer DEFAULT 0 NOT NULL,
    risk_reasons jsonb DEFAULT '[]'::jsonb NOT NULL,
    destination_hash character varying(64),
    ip_hash character varying(64),
    user_agent_hash character varying(64),
    captcha_provider character varying(32),
    captcha_outcome character varying(32),
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: campaign_send_decisions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.campaign_send_decisions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: campaign_send_runs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.campaign_send_runs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    campaign_id uuid NOT NULL,
    mode character varying(12) DEFAULT 'DRY_RUN'::character varying NOT NULL,
    status character varying(20) DEFAULT 'COMPLETE'::character varying NOT NULL,
    audience_kind character varying(30) DEFAULT 'ABANDONED_CARTS'::character varying NOT NULL,
    ...
    quiet_hours_at_run character varying(8) DEFAULT 'NO'::character varying NOT NULL,
    created_by uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.cart_abandonments (
    ...
    owner_kind character varying(8),
    owner_id character varying(128),
    item_count integer NOT NULL,
    subtotal_ugx bigint NOT NULL,
    reason character varying(30) DEFAULT 'STALE_TIMEOUT'::character varying NOT NULL,
...
CREATE TABLE public.cart_items (
    ...
    CONSTRAINT cart_items_quantity_bounded CHECK (((quantity >= 1) AND (quantity <= 999)))
);
...
CREATE TABLE public.carts (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    expires_at timestamp with time zone,
    CONSTRAINT carts_owner_complete CHECK ((((owner_kind IS NULL) AND (owner_id IS NULL)) OR ((owner_kind IS NOT NULL) AND (owner_id IS NOT NULL)))),
    CONSTRAINT carts_owner_kind_known CHECK (((owner_kind IS NULL) OR ((owner_kind)::text = ANY ((ARRAY['USER'::character varying, 'GUEST'::character varying])::text[])))),
    CONSTRAINT carts_version_positive CHECK ((version >= 1))
);
...
CREATE TABLE public.categories (
    ...
    default_shipping_class character varying(8),
    CONSTRAINT categories_default_shipping_class_check CHECK (((default_shipping_class IS NULL) OR ((default_shipping_class)::text = ANY ((ARRAY['small'::character varying, 'medium'::character varying, 'large'::character varying])::text[]))))
);


--
-- Name: cdp_event_ledger; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cdp_event_ledger (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    event_id character varying(255) NOT NULL,
    event_name character varying(100) NOT NULL,
    event_time timestamp with time zone NOT NULL,
...
--
-- Name: checkout_idempotency; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.checkout_idempotency (
    identity character varying(64) NOT NULL,
    principal_key character varying(96) NOT NULL,
    ...
    fencing_number integer DEFAULT 1 NOT NULL,
    lease_expires_at timestamp with time zone,
    attempt_number integer DEFAULT 1 NOT NULL,
    last_heartbeat_at timestamp with time zone,
    stage character varying(24) DEFAULT 'CLAIMED'::character varying NOT NULL,
    operation_state character varying(20) DEFAULT 'IN_PROGRESS'::character varying NOT NULL,
    CONSTRAINT checkout_idempotency_completed_has_order CHECK ((((state)::text <> 'COMPLETED'::text) OR (order_id IS NOT NULL))),
    CONSTRAINT checkout_idempotency_fence_positive CHECK (((fencing_number >= 1) AND (attempt_number >= 1))),
    CONSTRAINT checkout_idempotency_final_has_reason CHECK ((((state)::text <> 'FAILED_FINAL'::text) OR (failure_reason IS NOT NULL))),
    CONSTRAINT checkout_idempotency_operation_state_known CHECK (((operation_state)::text = ANY ((ARRAY['IN_PROGRESS'::character varying, 'FAILED_RETRYABLE'::character varying, 'FAILED_FINAL'::character varying, 'TERMINAL'::character varying])::text[]))),
    CONSTRAINT checkout_idempotency_stage_has_order CHECK ((((stage)::text <> ALL ((ARRAY['ORDER_CREATED'::character varying, 'INVENTORY_RESERVED'::character varying, 'BLOCKED_STOCK'::character varying, 'AWAITING_PAYMENT'::character varying, 'COMPLETED'::character varying])::text[])) OR (order_id IS NOT NULL))),
    CONSTRAINT checkout_idempotency_stage_known CHECK (((stage)::text = ANY ((ARRAY['CLAIMED'::character varying, 'PRICED'::character varying, 'ORDER_CREATED'::character varying, 'INVENTORY_RESERVED'::character varying, 'BLOCKED_STOCK'::character varying, 'FULFILMENT_QUEUED'::character varying, 'NOTIFICATION_QUEUED'::character varying, 'PAYMENT_READY'::character varying, 'PAYMENT_STARTED'::character varying, 'PAYMENT_PENDING'::character varying, 'PAYMENT_REVIEW'::character varying, 'ORDER_CONFIRMED'::character varying, 'COMPLETED'::character varying, 'AWAITING_PAYMENT'::character varying, 'FAILED_RETRYABLE'::character varying, 'FAILED_FINAL'::character varying])::text[]))),
    CONSTRAINT checkout_idempotency_state_known CHECK (((state)::text = ANY ((ARRAY['IN_PROGRESS'::character varying, 'COMPLETED'::character varying, 'FAILED_RETRYABLE'::character varying, 'FAILED_FINAL'::character varying])::text[])))
);


--
-- Name: checkout_side_effects; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.checkout_side_effects (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    checkout_identity character varying(64) NOT NULL,
    order_id uuid NOT NULL,
    event_type character varying(64) NOT NULL,
    policy_version character varying(48) NOT NULL,
    outbox_event_id uuid,
    recorded_at timestamp with time zone DEFAULT now() NOT NULL,
    trace_id character varying(128),
    CONSTRAINT checkout_side_effects_event_known CHECK (((event_type)::text = ANY ((ARRAY['ORDER_FULFILMENT_REQUIRED'::character varying, 'ORDER_ADMIN_NOTIFICATION_REQUIRED'::character varying, 'ORDER_CUSTOMER_NOTIFICATION_ELIGIBLE'::character varying, 'ORDER_PAYMENT_INITIATION_REQUIRED'::character varying, 'ORDER_PAYMENT_VERIFICATION_REQUIRED'::character varying, 'ORDER_LOYALTY_ELIGIBILITY_RECORDED'::character varying, 'ORDER_MEASUREMENT_ELIGIBILITY_RECORDED'::character varying])::text[])))
);


--
-- Name: commerce_os_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_os_records (
    id character varying(36) NOT NULL,
    module character varying(64) NOT NULL,
    record_type character varying(80) NOT NULL,
    safe_entity_ref character varying(160),
...
CREATE TABLE public.coupon_codes (
    ...
    code_normalised character varying(60) NOT NULL,
    code_type character varying(24) DEFAULT 'bulk_batch'::character varying NOT NULL,
    batch_id uuid,
    assigned_to_customer_id uuid,
    assigned_to_creator_id uuid,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT coupon_codes_code_type_chk CHECK (((code_type)::text = ANY ((ARRAY['public'::character varying, 'single_use'::character varying, 'personalised'::character varying, 'creator'::character varying, 'bulk_batch'::character varying])::text[]))),
...
CREATE TABLE public.coupon_redemptions (
    ...
    order_id uuid NOT NULL,
    customer_identity_hash character varying(64) NOT NULL,
...
--
-- Name: creator_attributions; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.creator_attributions (
    ...
    mechanism character varying(8) NOT NULL,
    confidence character varying(8) NOT NULL,
    attributed_revenue_ugx bigint DEFAULT 0 NOT NULL,
    is_primary boolean DEFAULT false NOT NULL,
    attributed_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT creator_attributions_confidence_chk CHECK (((confidence)::text = ANY ((ARRAY['high'::character varying, 'medium'::character varying, 'low'::character varying])::text[]))),
    CONSTRAINT creator_attributions_mechanism_chk CHECK (((mechanism)::text = ANY ((ARRAY['code'::character varying, 'link'::character varying, 'survey'::character varying])::text[])))
);


--
-- Name: creator_commissions; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.creator_commissions (
    ...
    reversed_reason character varying(160),
    payout_id uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT creator_commissions_status_chk CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'approved'::character varying, 'held'::character varying, 'reversed'::character varying, 'paid'::character varying])::text[])))
);


--
-- Name: creator_content_assets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.creator_content_assets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    creator_id uuid NOT NULL,
    deliverable_id uuid,
    ...
    platform_published_url character varying(500),
    rights_scope character varying(16),
    rights_expiry date,
    approved_for_ads boolean DEFAULT false NOT NULL,
...
--
-- Name: creator_contracts; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.creator_contracts (
    ...
    usage_rights_scope character varying(16),
...
CREATE TABLE public.creator_link_clicks (
    ...
    anonymous_id character varying(80),
    is_suspected_bot boolean DEFAULT false NOT NULL
);


--
-- Name: creator_links; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.creator_payouts (
    ...
    destination_masked character varying(40),
    ...
    CONSTRAINT creator_payouts_status_chk CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'approved'::character varying, 'processing'::character varying, 'settled'::character varying, 'failed'::character varying, 'cancelled'::character varying])::text[])))
);
...
CREATE TABLE public.creators (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    handle character varying(80) NOT NULL,
    legal_name character varying(160),
    phone_hash character varying(64),
    email_hash character varying(64),
    whatsapp_number_hash character varying(64),
    primary_platform character varying(40),
    tier character varying(12),
    niche_tags text[] DEFAULT '{}'::text[] NOT NULL,
    languages text[] DEFAULT '{}'::text[] NOT NULL,
    location_district character varying(80),
    status character varying(16) DEFAULT 'prospect'::character varying NOT NULL,
    owner_admin_id uuid,
    source character varying(80),
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT creators_status_chk CHECK (((status)::text = ANY ((ARRAY['prospect'::character varying, 'contacted'::character varying, 'negotiating'::character varying, 'active'::character varying, 'paused'::character varying, 'blocked'::character varying])::text[])))
);


--
-- Name: customer_badges; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: delivery_alias_corridor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_alias_corridor (
    alias character varying(120) NOT NULL,
    alias_type character varying(40) NOT NULL,
    district character varying(100) NOT NULL,
    anchor_area_in_gazetteer character varying(160),
    anchor_postcode character varying(8),
    anchor_area_slug character varying(160) NOT NULL,
    corridor character varying(40) NOT NULL,
    distance_band character varying(4) NOT NULL,
    band_confidence character varying(16),
    differs_from_anchor boolean DEFAULT false NOT NULL,
    note text,
    data_version integer DEFAULT 1 NOT NULL,
    CONSTRAINT delivery_alias_band_check CHECK (((distance_band)::text = ANY ((ARRAY['B0'::character varying, 'B1'::character varying, 'B2'::character varying, 'B3'::character varying, 'B4'::character varying, 'B5'::character varying, 'B6'::character varying])::text[])))
);


--
-- Name: delivery_bus_destination; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_bus_destination (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    route character varying(48) NOT NULL,
    destination_town character varying(120) NOT NULL,
    matching_district character varying(100) NOT NULL,
    region character varying(60),
    current_zone character varying(4),
...
--
-- Name: delivery_bus_rate_card; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_bus_rate_card (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    carrier character varying(80) NOT NULL,
    destination_town character varying(120) NOT NULL,
    destination_district character varying(100) NOT NULL,
    parcel_class character varying(8) NOT NULL,
    ...
    charged_at character varying(12) NOT NULL,
    ...
    created_by uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT delivery_bus_rate_card_charged_at_check CHECK (((charged_at)::text = ANY ((ARRAY['sending'::character varying, 'collection'::character varying])::text[]))),
    CONSTRAINT delivery_bus_rate_card_class_check CHECK (((parcel_class)::text = ANY ((ARRAY['small'::character varying, 'medium'::character varying, 'large'::character varying])::text[]))),
    CONSTRAINT delivery_bus_rate_card_fee_check CHECK ((fee_ugx >= 0)),
    CONSTRAINT delivery_bus_rate_card_transit_check CHECK (((transit_days_min >= 0) AND (transit_days_max >= transit_days_min))),
    CONSTRAINT delivery_bus_rate_card_window_check CHECK (((effective_to IS NULL) OR (effective_to > effective_from)))
);


--
-- Name: delivery_calibration_milestone; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_calibration_milestone (
    milestone character varying(48) NOT NULL,
    order_id uuid,
...
--
-- Name: delivery_calibration_proposal; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_calibration_proposal (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    factor_kind character varying(24) NOT NULL,
    scope_key character varying(160) NOT NULL,
    current_value numeric(10,4),
    current_state character varying(16) NOT NULL,
    ...
    decided_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT delivery_calibration_proposal_kind_check CHECK (((factor_kind)::text = ANY ((ARRAY['corridor_factor'::character varying, 'hour_factor'::character varying, 'detour_factor'::character varying, 'last_mile_minutes'::character varying])::text[]))),
    CONSTRAINT delivery_calibration_proposal_sample_check CHECK ((sample_size > 0)),
    CONSTRAINT delivery_calibration_proposal_state_check CHECK (((current_state)::text = ANY ((ARRAY['not_learned'::character varying, 'fitted'::character varying, 'set_by_hand'::character varying])::text[]))),
    CONSTRAINT delivery_calibration_proposal_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'accepted'::character varying, 'rejected'::character varying, 'edited'::character varying])::text[])))
);


--
-- Name: delivery_config_value; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_config_value (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    version_id uuid NOT NULL,
    config_key character varying(80) NOT NULL,
    config_value text,
    origin character varying(16) DEFAULT 'human'::character varying NOT NULL,
    sample_size integer,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT delivery_config_value_origin_check CHECK (((origin)::text = ANY ((ARRAY['human'::character varying, 'model_proposed'::character varying])::text[])))
);


--
-- Name: delivery_config_version; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_config_version (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    status character varying(12) DEFAULT 'draft'::character varying NOT NULL,
    ...
    reverted_from uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT delivery_config_version_publish_check CHECK ((((status)::text <> 'published'::text) OR ((published_by IS NOT NULL) AND (published_at IS NOT NULL) AND (reason IS NOT NULL)))),
    CONSTRAINT delivery_config_version_status_check CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'scheduled'::character varying, 'published'::character varying, 'superseded'::character varying, 'reverted'::character varying])::text[])))
);


--
-- Name: delivery_corridor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_corridor (
    area_slug character varying(160) NOT NULL,
    postcode character varying(8),
    delivery_zone character varying(4),
    district character varying(100) NOT NULL,
    sub_county_or_division character varying(160),
    area character varying(160) NOT NULL,
    corridor character varying(40) NOT NULL,
    distance_band character varying(4) NOT NULL,
    access_mode character varying(16) NOT NULL,
    assignment_confidence character varying(16),
    assignment_basis character varying(24),
    serviceable boolean DEFAULT true NOT NULL,
    centroid_lat numeric(9,6),
    centroid_lng numeric(9,6),
    centroid_source character varying(24),
    centroid_sample_size integer DEFAULT 0 NOT NULL,
    data_version integer DEFAULT 1 NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    fulfilment_mode character varying(16),
    CONSTRAINT delivery_corridor_access_check CHECK (((access_mode)::text = ANY ((ARRAY['road'::character varying, 'water'::character varying])::text[]))),
    CONSTRAINT delivery_corridor_band_check CHECK (((distance_band)::text = ANY ((ARRAY['B0'::character varying, 'B1'::character varying, 'B2'::character varying, 'B3'::character varying, 'B4'::character varying, 'B5'::character varying, 'B6'::character varying])::text[]))),
    CONSTRAINT delivery_corridor_centroid_check CHECK (((centroid_lat IS NULL) = (centroid_lng IS NULL))),
    CONSTRAINT delivery_corridor_fulfilment_mode_check CHECK (((fulfilment_mode IS NULL) OR ((fulfilment_mode)::text = ANY ((ARRAY['own_rider'::character varying, 'bus_parcel'::character varying, 'pickup_only'::character varying, 'unserviceable'::character varying])::text[]))))
);


--
-- Name: delivery_fee_variance; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_fee_variance (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    order_id uuid NOT NULL,
    ...
    agreement character varying(16) NOT NULL,
    applied_by uuid NOT NULL,
    applied_at timestamp with time zone DEFAULT now() NOT NULL,
    agreement_by uuid,
    agreement_at timestamp with time zone,
    cancelled_order boolean DEFAULT false NOT NULL,
    CONSTRAINT delivery_fee_variance_agreement_check CHECK (((agreement)::text = ANY ((ARRAY['not_required'::character varying, 'pending'::character varying, 'agreed'::character varying, 'declined'::character varying])::text[]))),
    CONSTRAINT delivery_fee_variance_disposition_check CHECK (((disposition)::text = ANY ((ARRAY['absorbed'::character varying, 'needs_agreement'::character varying])::text[]))),
    CONSTRAINT delivery_fee_variance_pairing_check CHECK (((((disposition)::text = 'absorbed'::text) AND ((agreement)::text = 'not_required'::text)) OR (((disposition)::text = 'needs_agreement'::text) AND ((agreement)::text = ANY ((ARRAY['pending'::character varying, 'agreed'::character varying, 'declined'::character varying])::text[]))))),
    CONSTRAINT delivery_fee_variance_reason_check CHECK (((reason)::text = ANY ((ARRAY['ADDRESS_CHANGED_BY_CUSTOMER'::character varying, 'AREA_MISMATCH_ON_RESOLUTION'::character varying, 'ACCESS_MODE_DIFFERENT'::character varying, 'REDELIVERY_AFTER_FAILED_ATTEMPT'::character varying, 'MANUAL_ADJUSTMENT_BY_OPS'::character varying])::text[])))
);


--
-- Name: delivery_learned_factor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_learned_factor (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    factor_kind character varying(24) NOT NULL,
    scope_key character varying(160) NOT NULL,
    value numeric(8,4) DEFAULT 1.0 NOT NULL,
    sample_size integer DEFAULT 0 NOT NULL,
    origin character varying(16) DEFAULT 'prior'::character varying NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    set_by uuid,
    CONSTRAINT delivery_learned_factor_kind_check CHECK (((factor_kind)::text = ANY ((ARRAY['corridor_factor'::character varying, 'hour_factor'::character varying, 'detour_factor'::character varying, 'last_mile_minutes'::character varying])::text[]))),
    CONSTRAINT delivery_learned_factor_origin_check CHECK (((origin)::text = ANY ((ARRAY['prior'::character varying, 'fitted'::character varying, 'human'::character varying])::text[]))),
    CONSTRAINT delivery_learned_factor_sample_check CHECK ((sample_size >= 0))
);


--
-- Name: delivery_name_collision; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_name_collision (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    collision_type character varying(48) NOT NULL,
    colliding_name character varying(160) NOT NULL,
    district_with_that_name character varying(100),
    area_sits_in_district character varying(100) NOT NULL,
    sub_county character varying(160),
    postcode character varying(8),
    area_slug character varying(160) NOT NULL,
    delivery_zone character varying(4),
    routing_rule text,
    data_version integer DEFAULT 1 NOT NULL,
    CONSTRAINT delivery_name_collision_type_check CHECK (((collision_type)::text = ANY ((ARRAY['AREA_NAME_MATCHES_OTHER_DISTRICT'::character varying, 'SUBCOUNTY_NAME_MATCHES_OTHER_DISTRICT'::character varying, 'AREA_NAME_MATCHES_OWN_DISTRICT'::character varying])::text[])))
);


--
-- Name: delivery_origin; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_origin (
    origin_code character varying(40) NOT NULL,
    name character varying(120) NOT NULL,
    role character varying(40) NOT NULL,
    street character varying(160),
    landmark_primary character varying(160),
    landmark_secondary character varying(160),
    area_slug character varying(160),
    district character varying(100),
    corridor character varying(40),
    distance_band character varying(4),
    latitude numeric(9,6) NOT NULL,
    longitude numeric(9,6) NOT NULL,
    coord_source character varying(60),
    coord_anchor character varying(300),
    coord_confidence character varying(60),
...
--
-- Name: delivery_pricing_policy; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_pricing_policy (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    singleton character varying(10) DEFAULT 'policy'::character varying NOT NULL,
...
--
-- Name: delivery_quote_capture; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_quote_capture (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    order_id uuid NOT NULL,
    area_slug character varying(160),
    alias_used character varying(120),
    corridor character varying(40),
    distance_band character varying(4),
    quoted_fee_ugx bigint,
    final_fee_ugx bigint,
    variance_reason character varying(48),
    ...
    parcel_class character varying(8),
    parcel_office_id uuid,
    priced_by character varying(24),
    parcel_count integer,
    per_parcel_fee_ugx bigint,
    CONSTRAINT delivery_quote_capture_cost_check CHECK (((actual_rider_cost_ugx IS NULL) OR (actual_rider_cost_ugx >= 0))),
    CONSTRAINT delivery_quote_capture_priced_by_check CHECK (((priced_by IS NULL) OR ((priced_by)::text = ANY ((ARRAY['delivery_model'::character varying, 'bus_rate_card'::character varying, 'legacy_fallback'::character varying, 'manual'::character varying])::text[]))))
);


--
-- Name: delivery_zone_policy; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.delivery_zone_policy (
    zone_code character varying(8) NOT NULL,
...
CREATE TABLE public.delivery_zones (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT delivery_zones_fee_non_negative CHECK ((fee_ugx >= 0))
);
...
CREATE TABLE public.devices (
    ...
    brand_normalised character varying(60) NOT NULL,
    model_normalised character varying(120) NOT NULL,
    model_aliases text[] DEFAULT '{}'::text[] NOT NULL,
    model_aliases_normalised text[] DEFAULT '{}'::text[] NOT NULL,
    slug character varying(160) NOT NULL,
    release_year integer,
    connector_type character varying(16),
    charging_wattage_max integer,
    screen_diagonal_mm integer,
    screen_width_mm integer,
    screen_height_mm integer,
    camera_cutout_type character varying(40),
...
--
-- Name: external_delivery_readiness_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.external_delivery_readiness_records (
...
--
-- Name: flash_sale_reservations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.flash_sale_reservations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    flash_sale_item_id uuid NOT NULL,
    customer_identity_hash character varying(64) NOT NULL,
    reservation_token character varying(80) NOT NULL,
    idempotency_key character varying(120) NOT NULL,
    quantity integer DEFAULT 1 NOT NULL,
    status character varying(12) DEFAULT 'reserved'::character varying NOT NULL,
    reserved_at timestamp with time zone DEFAULT now() NOT NULL,
    expires_at timestamp with time zone NOT NULL,
    released_at timestamp with time zone,
    CONSTRAINT flash_sale_reservations_qty_chk CHECK ((quantity > 0)),
    CONSTRAINT flash_sale_reservations_status_chk CHECK (((status)::text = ANY ((ARRAY['reserved'::character varying, 'confirmed'::character varying, 'released'::character varying, 'expired'::character varying])::text[])))
);
...
CREATE TABLE public.flash_sales (
    ...
    allocation_type character varying(24) DEFAULT 'fixed_units'::character varying NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT flash_sales_allocation_chk CHECK (((allocation_type)::text = ANY ((ARRAY['unlimited'::character varying, 'fixed_units'::character varying, 'percentage_of_stock'::character varying])::text[]))),
    CONSTRAINT flash_sales_status_chk CHECK (((status)::text = ANY ((ARRAY['draft'::character varying, 'scheduled'::character varying, 'live'::character varying, 'sold_out'::character varying, 'ended'::character varying, 'cancelled'::character varying])::text[]))),
...
--
-- Name: gamification_missions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: gsc_performance; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.gsc_performance (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    date date NOT NULL,
    page character varying(512) NOT NULL,
...
--
-- Name: legal_policy_versions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: loyalty_account_merges; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_account_merges (
...
CREATE TABLE public.loyalty_config (
    ...
    redemption_min_points integer,
    redemption_max_share_bps integer,
    budget_cap_points bigint,
    kill_switch boolean DEFAULT false NOT NULL,
    guest_backfill_lookback_days integer,
    guest_backfill_cap_points integer,
    singleton character varying(10) DEFAULT 'config'::character varying NOT NULL,
    referral_referrer_points integer,
    referral_referee_points integer,
    birthday_points integer,
    streak_target_orders integer,
    streak_window_days integer,
    streak_reward_points integer,
    chance_enabled boolean DEFAULT false NOT NULL,
    terms_version character varying(20)
);


--
-- Name: loyalty_daily_control_totals; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_daily_control_totals (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    ...
    computed_at timestamp with time zone DEFAULT now() NOT NULL,
    computed_by character varying(64) DEFAULT 'system'::character varying NOT NULL,
    trace_id character varying(128),
    CONSTRAINT loyalty_daily_control_totals_counts_non_negative CHECK (((entry_count >= 0) AND (accounts_with_balance >= 0))),
    CONSTRAINT loyalty_daily_control_totals_internally_consistent CHECK (((entry_count > 0) OR ((earn_points = 0) AND (redeem_points = 0) AND (reversal_points = 0) AND (expiry_points = 0) AND (adjustment_points = 0)))),
    CONSTRAINT loyalty_daily_control_totals_sign_discipline CHECK (((earn_points >= 0) AND (redeem_points <= 0) AND (expiry_points <= 0)))
);


--
-- Name: loyalty_draw_campaigns; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_draw_campaigns (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    ...
    CONSTRAINT loyalty_draw_campaigns_expiry_check CHECK (((token_expiry_days >= 1) AND (token_expiry_days <= 365))),
    CONSTRAINT loyalty_draw_campaigns_trigger_check CHECK (((trigger_event)::text = ANY ((ARRAY['order_delivered'::character varying, 'verification_scan'::character varying])::text[])))
);


--
-- Name: loyalty_draw_compliance; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_draw_compliance (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    basis character varying(30) DEFAULT 'none'::character varying NOT NULL,
    licence_reference character varying(120),
    licence_issuer character varying(160),
    licence_expires_at date,
    counsel_reference character varying(300),
    counsel_opinion_date date,
    min_age integer,
    jurisdiction character varying(8) DEFAULT 'UG'::character varying NOT NULL,
    acknowledged_by uuid,
    acknowledged_at timestamp with time zone,
    notes character varying(1000),
    singleton character varying(12) DEFAULT 'compliance'::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT loyalty_draw_compliance_ack_check CHECK ((((basis)::text = 'none'::text) OR ((acknowledged_at IS NOT NULL) AND (notes IS NOT NULL)))),
    CONSTRAINT loyalty_draw_compliance_age_check CHECK (((min_age IS NULL) OR ((min_age >= 13) AND (min_age <= 30)))),
    CONSTRAINT loyalty_draw_compliance_basis_check CHECK (((basis)::text = ANY ((ARRAY['none'::character varying, 'licensed'::character varying, 'counsel_advised_exempt'::character varying, 'business_accepted'::character varying])::text[]))),
    CONSTRAINT loyalty_draw_compliance_counsel_check CHECK ((((basis)::text <> 'counsel_advised_exempt'::text) OR ((counsel_reference IS NOT NULL) AND (counsel_opinion_date IS NOT NULL)))),
    CONSTRAINT loyalty_draw_compliance_licensed_check CHECK ((((basis)::text <> 'licensed'::text) OR ((licence_reference IS NOT NULL) AND (licence_expires_at IS NOT NULL))))
);


--
-- Name: loyalty_draw_prizes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_draw_prizes (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    campaign_id uuid NOT NULL,
...
--
-- Name: loyalty_draw_results; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_draw_results (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: loyalty_draw_tokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_draw_tokens (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    campaign_id uuid NOT NULL,
    user_id uuid NOT NULL,
    account_id uuid,
    ...
    CONSTRAINT loyalty_draw_tokens_status_check CHECK (((status)::text = ANY ((ARRAY['available'::character varying, 'played'::character varying, 'expired'::character varying])::text[])))
);


--
-- Name: loyalty_expiry_notices; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_expiry_notices (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    account_id uuid NOT NULL,
    earn_entry_id uuid NOT NULL,
    notice_kind character varying(10) NOT NULL,
    channel character varying(20) NOT NULL,
...
--
-- Name: loyalty_fraud_signals; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_fraud_signals (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    account_id uuid,
    user_id uuid,
    signal_type character varying(40) NOT NULL,
...
--
-- Name: loyalty_liability_snapshots; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_liability_snapshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.loyalty_referrals (
    ...
    CONSTRAINT loyalty_referrals_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'awarded'::character varying, 'rejected'::character varying])::text[])))
);
...
CREATE TABLE public.loyalty_rules (
    ...
    version integer NOT NULL,
    earn_basis character varying(20) NOT NULL,
    rate integer NOT NULL,
    cap_per_period integer,
    cap_period character varying(10),
...
--
-- Name: loyalty_tier_assignments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.loyalty_tier_assignments (
    account_id uuid NOT NULL,
...
--
-- Name: measurement_destination_credentials; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.measurement_destination_credentials (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    destination_id uuid NOT NULL,
    destination_key character varying(100) NOT NULL,
    credential_key character varying(100) NOT NULL,
    encrypted_value text NOT NULL,
    encryption_iv character varying(100) NOT NULL,
    encryption_tag character varying(100) NOT NULL,
    encryption_version integer DEFAULT 1 NOT NULL,
    masked_hint character varying(255) NOT NULL,
...
--
-- Name: measurement_gtm_plans; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.measurement_gtm_plans (
    id character varying(64) NOT NULL,
    plan jsonb,
    diff jsonb,
    plan_checksum character varying(64),
    status character varying(32) DEFAULT 'DRY_RUN'::character varying NOT NULL,
    version integer DEFAULT 1 NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    created_by uuid,
...
CREATE TABLE public.measurement_paid_social_delivery_logs (
    ...
    created_by uuid,
    updated_by uuid,
    destination_key character varying(100) DEFAULT 'unknown'::character varying NOT NULL,
    platform_event_name character varying(100),
    provider_status_code integer,
    provider_request_id character varying(255),
    attempt_count integer DEFAULT 1 NOT NULL,
    next_retry_at timestamp with time zone,
    payload_quality_score real,
    match_keys_present jsonb,
    redacted_payload_summary jsonb,
    redacted_response_summary jsonb,
...
CREATE TABLE public.measurement_paid_social_destinations (
    ...
    created_by uuid,
    updated_by uuid,
    key character varying(100) DEFAULT 'unknown'::character varying NOT NULL,
    display_name character varying(255) DEFAULT 'Unknown'::character varying NOT NULL,
    dry_run boolean DEFAULT false NOT NULL,
    allowed_events jsonb DEFAULT '[]'::jsonb NOT NULL,
    blocked_events jsonb DEFAULT '[]'::jsonb NOT NULL,
...
--
-- Name: notification_template_overrides; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.order_events (
    ...
    occurred_at timestamp with time zone DEFAULT now() NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT order_events_actor_type_chk CHECK (((actor_type)::text = ANY ((ARRAY['customer'::character varying, 'administrator'::character varying, 'system'::character varying, 'payment_provider'::character varying, 'fulfilment_worker'::character varying, 'migration'::character varying])::text[]))),
    CONSTRAINT order_events_source_chk CHECK (((source)::text = ANY ((ARRAY['admin_api'::character varying, 'payment'::character varying, 'fulfilment'::character varying, 'customer'::character varying, 'system'::character varying, 'migration'::character varying])::text[])))
);
...
CREATE TABLE public.order_items (
    ...
    canonical_unit_price bigint DEFAULT 0 NOT NULL,
...
CREATE TABLE public.orders (
    ...
    pricing_base_subtotal bigint DEFAULT 0 NOT NULL,
    pricing_discount_total bigint DEFAULT 0 NOT NULL,
    pricing_tax_total bigint DEFAULT 0 NOT NULL,
    pricing_calculation_version character varying(40) DEFAULT 'legacy-unadjusted-v1'::character varying NOT NULL,
    pricing_snapshot jsonb,
    reservation_state character varying(24) DEFAULT 'PENDING'::character varying NOT NULL,
...
--
-- Name: product_device_compatibility; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.product_device_compatibility (
    product_id uuid NOT NULL,
    device_id uuid NOT NULL,
    fit_type character varying(20) NOT NULL,
...
--
-- Name: product_rating_aggregate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.product_rating_aggregate (
    product_id uuid NOT NULL,
...
CREATE TABLE public.products (
    ...
    inventory_policy character varying(24) DEFAULT 'STOCK_CONTROLLED'::character varying NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    shipping_class character varying(8),
    CONSTRAINT products_inventory_policy_known CHECK (((inventory_policy)::text = ANY ((ARRAY['STOCK_CONTROLLED'::character varying, 'BACKORDER_ALLOWED'::character varying, 'NON_STOCK_ITEM'::character varying])::text[]))),
    CONSTRAINT products_shipping_class_check CHECK (((shipping_class IS NULL) OR ((shipping_class)::text = ANY ((ARRAY['small'::character varying, 'medium'::character varying, 'large'::character varying])::text[])))),
    CONSTRAINT products_stock_non_negative CHECK (((stock_quantity >= 0) AND (reserved_quantity >= 0)))
);
...
CREATE TABLE public.promotion_versions (
    ...
    approved_at timestamp with time zone,
    approved_by uuid,
    budget_cap_ugx bigint,
    budget_consumed_ugx bigint DEFAULT 0 NOT NULL,
    min_margin_bps_floor integer,
    CONSTRAINT promotion_versions_budget_cap_chk CHECK (((budget_cap_ugx IS NULL) OR (budget_cap_ugx >= 0))),
    CONSTRAINT promotion_versions_budget_consumed_chk CHECK ((budget_consumed_ugx >= 0)),
    ...
    CONSTRAINT promotion_versions_margin_floor_chk CHECK (((min_margin_bps_floor IS NULL) OR ((min_margin_bps_floor >= 0) AND (min_margin_bps_floor <= 10000)))),
...
CREATE TABLE public.redirects (
    ...
    to_path character varying(512) NOT NULL,
    ...
    CONSTRAINT redirects_no_self_loop_chk CHECK (((from_path)::text <> (to_path)::text)),
    CONSTRAINT redirects_status_chk CHECK ((status_code = ANY (ARRAY[301, 302, 307, 308])))
);
...
CREATE TABLE public.review_media (
    ...
    storage_url character varying(500) NOT NULL,
    media_type character varying(24) NOT NULL,
    display_order integer DEFAULT 0 NOT NULL
);
...
CREATE TABLE public.review_votes (
    review_id uuid NOT NULL,
    voter_identity_hash character varying(64) NOT NULL,
    vote character varying(12) NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT review_votes_vote_chk CHECK (((vote)::text = ANY ((ARRAY['helpful'::character varying, 'not_helpful'::character varying])::text[])))
);
...
CREATE TABLE public.reviews (
    ...
    rejection_reason character varying(120),
    flag_reason character varying(120),
    ...
    CONSTRAINT reviews_status_chk CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'published'::character varying, 'rejected'::character varying, 'flagged'::character varying])::text[])))
);


--
-- Name: role_grant_requests; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ug_area; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_area (
    area_slug character varying(160) NOT NULL,
    postcode character varying(8),
    parish_or_area_clean character varying(160) NOT NULL,
    parish_or_area_source character varying(160),
    display_label character varying(220) NOT NULL,
    current_district character varying(100) NOT NULL,
    district_2019_source character varying(100),
    district_changed boolean DEFAULT false NOT NULL,
    region character varying(60),
    county_or_municipality character varying(120),
    subcounty_or_division character varying(120),
    delivery_zone_code character varying(8),
...
--
-- Name: ug_area_alias; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_area_alias (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    alias character varying(160) NOT NULL,
    normalised_alias character varying(160) NOT NULL,
    area_slug character varying(160) NOT NULL,
    confidence character varying(20) NOT NULL,
...
--
-- Name: ug_area_group; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_area_group (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: ug_area_group_member; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_area_group_member (
...
--
-- Name: ug_data_exception; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_data_exception (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    exception_type character varying(60) NOT NULL,
    district character varying(100),
    postcode character varying(8),
    area_ref character varying(160),
    description text,
    source_row jsonb,
    data_version integer NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
...
--
-- Name: ug_landmark; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_landmark (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    area_slug character varying(160) NOT NULL,
    name character varying(160) NOT NULL,
    landmark_type character varying(30) NOT NULL,
...
--
-- Name: ug_pickup_point; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_pickup_point (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(160) NOT NULL,
    ...
    bus_route character varying(48)
);


--
-- Name: ug_search_miss; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ug_search_miss (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    raw_query character varying(200) NOT NULL,
    normalised_query character varying(200) NOT NULL,
    session_id character varying(80),
    customer_id uuid,
    result_count integer DEFAULT 0 NOT NULL,
    resolved_area_slug character varying(160),
    resolved_via character varying(20),
    device_hint character varying(120),
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.user_mfa_recovery_codes (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT user_mfa_recovery_code_hash_len CHECK ((char_length((code_hash)::text) = 64))
);
...
CREATE TABLE public.users (
    ...
    last_risk_reasons jsonb,
    suspended_at timestamp with time zone,
    suspended_by uuid,
    banned_at timestamp with time zone,
    banned_by uuid,
    sessions_invalidated_after timestamp with time zone,
    referral_code character varying(12),
    date_of_birth date,
    chance_self_excluded_at timestamp with time zone
);
...
--
-- Name: address_audit address_audit_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.address_audit
    ADD CONSTRAINT address_audit_pkey PRIMARY KEY (id);
...
--
-- Name: analytics_saved_views analytics_saved_views_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auth_identity_links auth_identity_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_identity_links
    ADD CONSTRAINT auth_identity_links_pkey PRIMARY KEY (id);


--
-- Name: auth_oauth_states auth_oauth_states_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_oauth_states
    ADD CONSTRAINT auth_oauth_states_pkey PRIMARY KEY (id);


--
-- Name: auth_oauth_states auth_oauth_states_state_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_oauth_states
    ADD CONSTRAINT auth_oauth_states_state_hash_key UNIQUE (state_hash);


--
-- Name: auth_provider_configs auth_provider_configs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auth_signin_tokens auth_signin_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_signin_tokens
    ADD CONSTRAINT auth_signin_tokens_pkey PRIMARY KEY (id);


--
-- Name: auth_signin_tokens auth_signin_tokens_token_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_signin_tokens
    ADD CONSTRAINT auth_signin_tokens_token_hash_key UNIQUE (token_hash);


--
-- Name: auth_signup_risk_events auth_signup_risk_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_signup_risk_events
    ADD CONSTRAINT auth_signup_risk_events_pkey PRIMARY KEY (id);
...
--
-- Name: campaign_send_decisions campaign_send_decisions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.campaign_send_decisions
    ADD CONSTRAINT campaign_send_decisions_pkey PRIMARY KEY (id);


--
-- Name: campaign_send_runs campaign_send_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.campaign_send_runs
    ADD CONSTRAINT campaign_send_runs_pkey PRIMARY KEY (id);
...
--
-- Name: cdp_event_ledger cdp_event_ledger_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cdp_event_ledger
    ADD CONSTRAINT cdp_event_ledger_pkey PRIMARY KEY (id);
...
--
-- Name: checkout_idempotency checkout_idempotency_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checkout_idempotency
    ADD CONSTRAINT checkout_idempotency_pkey PRIMARY KEY (identity);


--
-- Name: checkout_side_effects checkout_side_effects_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checkout_side_effects
    ADD CONSTRAINT checkout_side_effects_pkey PRIMARY KEY (id);


--
-- Name: commerce_os_records commerce_os_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_os_records
    ADD CONSTRAINT commerce_os_records_pkey PRIMARY KEY (id);
...
--
-- Name: creator_attributions creator_attributions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_attributions
    ADD CONSTRAINT creator_attributions_pkey PRIMARY KEY (id);


--
-- Name: creator_commissions creator_commissions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_commissions
    ADD CONSTRAINT creator_commissions_pkey PRIMARY KEY (id);


--
-- Name: creator_content_assets creator_content_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_content_assets
    ADD CONSTRAINT creator_content_assets_pkey PRIMARY KEY (id);


--
-- Name: creator_contracts creator_contracts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_contracts
    ADD CONSTRAINT creator_contracts_pkey PRIMARY KEY (id);
...
--
-- Name: creator_links creator_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customer_badges customer_badges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_badges
    ADD CONSTRAINT customer_badges_pkey PRIMARY KEY (id);
...
--
-- Name: delivery_alias_corridor delivery_alias_corridor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_alias_corridor
    ADD CONSTRAINT delivery_alias_corridor_pkey PRIMARY KEY (alias);


--
-- Name: delivery_bus_destination delivery_bus_destination_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_bus_destination
    ADD CONSTRAINT delivery_bus_destination_pkey PRIMARY KEY (id);


--
-- Name: delivery_bus_rate_card delivery_bus_rate_card_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_bus_rate_card
    ADD CONSTRAINT delivery_bus_rate_card_pkey PRIMARY KEY (id);


--
-- Name: delivery_calibration_milestone delivery_calibration_milestone_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_calibration_milestone
    ADD CONSTRAINT delivery_calibration_milestone_pkey PRIMARY KEY (milestone);


--
-- Name: delivery_calibration_proposal delivery_calibration_proposal_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_calibration_proposal
    ADD CONSTRAINT delivery_calibration_proposal_pkey PRIMARY KEY (id);


--
-- Name: delivery_config_value delivery_config_value_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_config_value
    ADD CONSTRAINT delivery_config_value_pkey PRIMARY KEY (id);


--
-- Name: delivery_config_version delivery_config_version_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_config_version
    ADD CONSTRAINT delivery_config_version_pkey PRIMARY KEY (id);


--
-- Name: delivery_corridor delivery_corridor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_corridor
    ADD CONSTRAINT delivery_corridor_pkey PRIMARY KEY (area_slug);


--
-- Name: delivery_fee_variance delivery_fee_variance_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_fee_variance
    ADD CONSTRAINT delivery_fee_variance_pkey PRIMARY KEY (id);


--
-- Name: delivery_learned_factor delivery_learned_factor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_learned_factor
    ADD CONSTRAINT delivery_learned_factor_pkey PRIMARY KEY (id);


--
-- Name: delivery_name_collision delivery_name_collision_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_name_collision
    ADD CONSTRAINT delivery_name_collision_pkey PRIMARY KEY (id);


--
-- Name: delivery_origin delivery_origin_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_origin
    ADD CONSTRAINT delivery_origin_pkey PRIMARY KEY (origin_code);


--
-- Name: delivery_pricing_policy delivery_pricing_policy_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_pricing_policy
    ADD CONSTRAINT delivery_pricing_policy_pkey PRIMARY KEY (id);


--
-- Name: delivery_quote_capture delivery_quote_capture_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_quote_capture
    ADD CONSTRAINT delivery_quote_capture_pkey PRIMARY KEY (id);


--
-- Name: delivery_zone_policy delivery_zone_policy_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_zone_policy
    ADD CONSTRAINT delivery_zone_policy_pkey PRIMARY KEY (zone_code);
...
--
-- Name: external_delivery_readiness_records external_delivery_readiness_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.external_delivery_readiness_records
    ADD CONSTRAINT external_delivery_readiness_records_pkey PRIMARY KEY (kind);
...
--
-- Name: flash_sale_reservations flash_sale_reservations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flash_sale_reservations
    ADD CONSTRAINT flash_sale_reservations_pkey PRIMARY KEY (id);
...
--
-- Name: gamification_missions gamification_missions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gamification_missions
    ADD CONSTRAINT gamification_missions_pkey PRIMARY KEY (id);


--
-- Name: gsc_performance gsc_performance_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legal_policy_versions legal_policy_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.legal_policy_versions
    ADD CONSTRAINT legal_policy_versions_pkey PRIMARY KEY (id);


--
-- Name: loyalty_account_merges loyalty_account_merges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_account_merges
    ADD CONSTRAINT loyalty_account_merges_pkey PRIMARY KEY (merged_account_id);
...
--
-- Name: loyalty_daily_control_totals loyalty_daily_control_totals_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_daily_control_totals
    ADD CONSTRAINT loyalty_daily_control_totals_pkey PRIMARY KEY (id);


--
-- Name: loyalty_draw_campaigns loyalty_draw_campaigns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_campaigns
    ADD CONSTRAINT loyalty_draw_campaigns_pkey PRIMARY KEY (id);


--
-- Name: loyalty_draw_compliance loyalty_draw_compliance_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_compliance
    ADD CONSTRAINT loyalty_draw_compliance_pkey PRIMARY KEY (id);


--
-- Name: loyalty_draw_prizes loyalty_draw_prizes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_prizes
    ADD CONSTRAINT loyalty_draw_prizes_pkey PRIMARY KEY (id);


--
-- Name: loyalty_draw_results loyalty_draw_results_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_results
    ADD CONSTRAINT loyalty_draw_results_pkey PRIMARY KEY (id);


--
-- Name: loyalty_draw_tokens loyalty_draw_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_tokens
    ADD CONSTRAINT loyalty_draw_tokens_pkey PRIMARY KEY (id);


--
-- Name: loyalty_expiry_notices loyalty_expiry_notices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_expiry_notices
    ADD CONSTRAINT loyalty_expiry_notices_pkey PRIMARY KEY (id);


--
-- Name: loyalty_fraud_signals loyalty_fraud_signals_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_fraud_signals
    ADD CONSTRAINT loyalty_fraud_signals_pkey PRIMARY KEY (id);
...
--
-- Name: loyalty_liability_snapshots loyalty_liability_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_liability_snapshots
    ADD CONSTRAINT loyalty_liability_snapshots_pkey PRIMARY KEY (id);
...
--
-- Name: loyalty_tier_assignments loyalty_tier_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_tier_assignments
    ADD CONSTRAINT loyalty_tier_assignments_pkey PRIMARY KEY (account_id);
...
ALTER TABLE ONLY public.loyalty_tiers
    ADD CONSTRAINT loyalty_tiers_pkey PRIMARY KEY (code);
...
--
-- Name: measurement_destination_credentials measurement_destination_credentials_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_destination_credentials
    ADD CONSTRAINT measurement_destination_credentials_pkey PRIMARY KEY (id);
...
--
-- Name: measurement_gtm_plans measurement_gtm_plans_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_gtm_plans
    ADD CONSTRAINT measurement_gtm_plans_pkey PRIMARY KEY (id);
...
--
-- Name: notification_template_overrides notification_template_overrides_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_device_compatibility product_device_compatibility_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_device_compatibility
    ADD CONSTRAINT product_device_compatibility_pkey PRIMARY KEY (product_id, device_id);
...
--
-- Name: product_rating_aggregate product_rating_aggregate_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_rating_aggregate
    ADD CONSTRAINT product_rating_aggregate_pkey PRIMARY KEY (product_id);
...
--
-- Name: products products_reserved_within_stock; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE public.products
    ADD CONSTRAINT products_reserved_within_stock CHECK ((reserved_quantity <= stock_quantity)) NOT VALID;
...
ALTER TABLE ONLY public.review_votes
    ADD CONSTRAINT review_votes_pkey PRIMARY KEY (review_id, voter_identity_hash);
...
--
-- Name: role_grant_requests role_grant_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.role_grant_requests
    ADD CONSTRAINT role_grant_requests_pkey PRIMARY KEY (id);
...
--
-- Name: ug_area_alias ug_area_alias_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_area_alias
    ADD CONSTRAINT ug_area_alias_pkey PRIMARY KEY (id);


--
-- Name: ug_area_group ug_area_group_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_area_group
    ADD CONSTRAINT ug_area_group_pkey PRIMARY KEY (id);


--
-- Name: ug_area ug_area_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_area
    ADD CONSTRAINT ug_area_pkey PRIMARY KEY (area_slug);


--
-- Name: ug_data_exception ug_data_exception_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_data_exception
    ADD CONSTRAINT ug_data_exception_pkey PRIMARY KEY (id);


--
-- Name: ug_landmark ug_landmark_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_landmark
    ADD CONSTRAINT ug_landmark_pkey PRIMARY KEY (id);


--
-- Name: ug_pickup_point ug_pickup_point_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_pickup_point
    ADD CONSTRAINT ug_pickup_point_pkey PRIMARY KEY (id);


--
-- Name: ug_search_miss ug_search_miss_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: address_audit_address_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX address_audit_address_idx ON public.address_audit USING btree (address_id);


--
-- Name: address_audit_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX address_audit_order_idx ON public.address_audit USING btree (order_id);


--
-- Name: analytics_alert_rules_enabled_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX analytics_alert_rules_enabled_idx ON public.analytics_alert_rules USING btree (enabled, metric_key);


--
-- Name: analytics_alert_rules_owner_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX analytics_alert_rules_owner_name_idx ON public.analytics_alert_rules USING btree (owner_id, lower((name)::text));


--
-- Name: analytics_saved_views_owner_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX analytics_saved_views_owner_name_idx ON public.analytics_saved_views USING btree (owner_id, lower((name)::text));


--
-- Name: analytics_saved_views_scope_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX analytics_saved_views_scope_idx ON public.analytics_saved_views USING btree (scope);
...
--
-- Name: audit_logs_entity_time_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX audit_logs_entity_time_idx ON public.audit_logs USING btree (entity, entity_id, created_at DESC);


--
-- Name: auth_identity_links_provider_subject_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX auth_identity_links_provider_subject_uq ON public.auth_identity_links USING btree (provider, provider_subject);


--
-- Name: auth_identity_links_user_provider_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX auth_identity_links_user_provider_uq ON public.auth_identity_links USING btree (user_id, provider);


--
-- Name: auth_provider_configs_provider_audience_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX auth_provider_configs_provider_audience_uq ON public.auth_provider_configs USING btree (provider, audience);


--
-- Name: auth_sessions_family_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX auth_sessions_family_idx ON public.auth_sessions USING btree (family_id);


--
-- Name: auth_sessions_refresh_expiry_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX auth_sessions_refresh_expiry_idx ON public.auth_sessions USING btree (refresh_expires_at);


--
-- Name: auth_sessions_refresh_hash_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX auth_sessions_refresh_hash_uq ON public.auth_sessions USING btree (refresh_hash);
...
CREATE INDEX auth_sessions_user_active_idx ON public.auth_sessions USING btree (user_id) WHERE (revoked_at IS NULL);


--
-- Name: auth_signin_tokens_destination_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX auth_signin_tokens_destination_idx ON public.auth_signin_tokens USING btree (destination_hash, created_at);
...
--
-- Name: campaign_send_decisions_run_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX campaign_send_decisions_run_idx ON public.campaign_send_decisions USING btree (run_id);


--
-- Name: campaign_send_decisions_subject_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX campaign_send_decisions_subject_idx ON public.campaign_send_decisions USING btree (subject_ref);


--
-- Name: campaign_send_runs_campaign_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX campaign_send_runs_campaign_idx ON public.campaign_send_runs USING btree (campaign_id);


--
-- Name: cart_abandonments_classified_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cart_abandonments_classified_idx ON public.cart_abandonments USING btree (classified_at);
...
--
-- Name: cart_abandonments_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cart_abandonments_status_idx ON public.cart_abandonments USING btree (status);
...
--
-- Name: cart_items_cart_product_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX cart_items_cart_product_idx ON public.cart_items USING btree (cart_id, product_id);
...
--
-- Name: carts_expires_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX carts_expires_at_idx ON public.carts USING btree (expires_at) WHERE (expires_at IS NOT NULL);


--
-- Name: carts_owner_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX carts_owner_idx ON public.carts USING btree (owner_kind, owner_id);
...
--
-- Name: cdp_ledger_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_created_at_idx ON public.cdp_event_ledger USING btree (created_at);


--
-- Name: cdp_ledger_event_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_event_name_idx ON public.cdp_event_ledger USING btree (event_name);


--
-- Name: cdp_ledger_event_time_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_event_time_idx ON public.cdp_event_ledger USING btree (event_time);


--
-- Name: cdp_ledger_fp_client_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_fp_client_idx ON public.cdp_event_ledger USING btree (fp_client_id);


--
-- Name: cdp_ledger_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_order_idx ON public.cdp_event_ledger USING btree (order_id);


--
-- Name: cdp_ledger_session_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_session_idx ON public.cdp_event_ledger USING btree (session_id);


--
-- Name: cdp_ledger_unique_event_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX cdp_ledger_unique_event_idx ON public.cdp_event_ledger USING btree (event_id);


--
-- Name: cdp_ledger_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX cdp_ledger_user_idx ON public.cdp_event_ledger USING btree (user_id);
...
--
-- Name: checkout_idempotency_expires_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_idempotency_expires_idx ON public.checkout_idempotency USING btree (expires_at);


--
-- Name: checkout_idempotency_in_progress_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_idempotency_in_progress_idx ON public.checkout_idempotency USING btree (updated_at) WHERE ((state)::text = 'IN_PROGRESS'::text);


--
-- Name: checkout_idempotency_lease_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_idempotency_lease_idx ON public.checkout_idempotency USING btree (lease_expires_at) WHERE ((state)::text = 'IN_PROGRESS'::text);


--
-- Name: checkout_idempotency_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX checkout_idempotency_order_idx ON public.checkout_idempotency USING btree (order_id) WHERE (order_id IS NOT NULL);


--
-- Name: checkout_idempotency_principal_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_idempotency_principal_idx ON public.checkout_idempotency USING btree (principal_key, created_at DESC);


--
-- Name: checkout_idempotency_stage_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_idempotency_stage_idx ON public.checkout_idempotency USING btree (stage, updated_at DESC);


--
-- Name: checkout_idempotency_unresolved_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_idempotency_unresolved_idx ON public.checkout_idempotency USING btree (stage) WHERE ((stage)::text = ANY ((ARRAY['ORDER_CREATED'::character varying, 'INVENTORY_RESERVED'::character varying, 'BLOCKED_STOCK'::character varying, 'FULFILMENT_QUEUED'::character varying, 'NOTIFICATION_QUEUED'::character varying, 'PAYMENT_READY'::character varying, 'PAYMENT_STARTED'::character varying, 'PAYMENT_PENDING'::character varying, 'PAYMENT_REVIEW'::character varying])::text[]));


--
-- Name: checkout_side_effects_identity_event_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX checkout_side_effects_identity_event_idx ON public.checkout_side_effects USING btree (checkout_identity, event_type);


--
-- Name: checkout_side_effects_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX checkout_side_effects_order_idx ON public.checkout_side_effects USING btree (order_id);


--
-- Name: commerce_os_records_entity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_os_records_entity_idx ON public.commerce_os_records USING btree (module, safe_entity_ref);


--
-- Name: commerce_os_records_idempotency_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX commerce_os_records_idempotency_idx ON public.commerce_os_records USING btree (idempotency_key) WHERE (idempotency_key IS NOT NULL);


--
-- Name: commerce_os_records_module_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_os_records_module_created_idx ON public.commerce_os_records USING btree (module, created_at);
...
--
-- Name: coupon_codes_batch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coupon_codes_batch_idx ON public.coupon_codes USING btree (batch_id);


--
-- Name: coupon_codes_code_normalised_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX coupon_codes_code_normalised_idx ON public.coupon_codes USING btree (code_normalised);


--
-- Name: coupon_codes_promotion_active_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coupon_codes_promotion_active_idx ON public.coupon_codes USING btree (promotion_definition_id, is_active);


--
-- Name: coupon_redemptions_coupon_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX coupon_redemptions_coupon_order_idx ON public.coupon_redemptions USING btree (coupon_id, order_id);


--
-- Name: coupon_redemptions_identity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX coupon_redemptions_identity_idx ON public.coupon_redemptions USING btree (customer_identity_hash, redeemed_at);


--
-- Name: creator_attributions_creator_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creator_attributions_creator_idx ON public.creator_attributions USING btree (creator_id, attributed_at);


--
-- Name: creator_attributions_order_creator_mech_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX creator_attributions_order_creator_mech_idx ON public.creator_attributions USING btree (order_id, creator_id, mechanism);


--
-- Name: creator_attributions_order_primary_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX creator_attributions_order_primary_idx ON public.creator_attributions USING btree (order_id) WHERE is_primary;


--
-- Name: creator_commissions_order_creator_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX creator_commissions_order_creator_idx ON public.creator_commissions USING btree (order_id, creator_id);


--
-- Name: creator_commissions_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creator_commissions_status_idx ON public.creator_commissions USING btree (status, hold_until);


--
-- Name: creator_content_assets_creator_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creator_content_assets_creator_idx ON public.creator_content_assets USING btree (creator_id);


--
-- Name: creator_contracts_creator_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creator_contracts_creator_idx ON public.creator_contracts USING btree (creator_id, status);


--
-- Name: creator_link_clicks_link_occurred_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creator_link_clicks_link_occurred_idx ON public.creator_link_clicks USING btree (link_id, occurred_at);


--
-- Name: creator_links_short_code_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX creator_links_short_code_idx ON public.creator_links USING btree (short_code);


--
-- Name: creator_payouts_creator_period_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creator_payouts_creator_period_idx ON public.creator_payouts USING btree (creator_id, period_start);


--
-- Name: creator_payouts_idempotency_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX creator_payouts_idempotency_idx ON public.creator_payouts USING btree (idempotency_key);


--
-- Name: creators_handle_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX creators_handle_idx ON public.creators USING btree (handle);


--
-- Name: creators_phone_hash_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX creators_phone_hash_idx ON public.creators USING btree (phone_hash);
...
--
-- Name: customer_badges_user_badge_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX customer_badges_user_badge_uq ON public.customer_badges USING btree (user_id, badge_id);


--
-- Name: customer_badges_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_badges_user_idx ON public.customer_badges USING btree (user_id);
...
--
-- Name: delivery_bus_destination_district_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_bus_destination_district_idx ON public.delivery_bus_destination USING btree (matching_district);


--
-- Name: delivery_bus_destination_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_bus_destination_uq ON public.delivery_bus_destination USING btree (route, destination_town);


--
-- Name: delivery_bus_rate_card_lookup_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_bus_rate_card_lookup_idx ON public.delivery_bus_rate_card USING btree (destination_town, destination_district, parcel_class);


--
-- Name: delivery_bus_rate_card_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_bus_rate_card_uq ON public.delivery_bus_rate_card USING btree (carrier, destination_town, destination_district, parcel_class, version);


--
-- Name: delivery_calibration_proposal_pending_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_calibration_proposal_pending_uq ON public.delivery_calibration_proposal USING btree (factor_kind, scope_key) WHERE ((status)::text = 'pending'::text);


--
-- Name: delivery_calibration_proposal_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_calibration_proposal_status_idx ON public.delivery_calibration_proposal USING btree (status);


--
-- Name: delivery_config_value_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_config_value_uq ON public.delivery_config_value USING btree (version_id, config_key);


--
-- Name: delivery_config_version_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_config_version_status_idx ON public.delivery_config_version USING btree (status);


--
-- Name: delivery_corridor_band_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_corridor_band_idx ON public.delivery_corridor USING btree (distance_band);


--
-- Name: delivery_corridor_corridor_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_corridor_corridor_idx ON public.delivery_corridor USING btree (corridor);


--
-- Name: delivery_fee_variance_order_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_fee_variance_order_idx ON public.delivery_fee_variance USING btree (order_id);


--
-- Name: delivery_fee_variance_pending_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_fee_variance_pending_idx ON public.delivery_fee_variance USING btree (agreement) WHERE ((agreement)::text = 'pending'::text);


--
-- Name: delivery_learned_factor_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_learned_factor_uq ON public.delivery_learned_factor USING btree (factor_kind, scope_key);


--
-- Name: delivery_name_collision_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_name_collision_name_idx ON public.delivery_name_collision USING btree (lower((colliding_name)::text));


--
-- Name: delivery_name_collision_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_name_collision_uq ON public.delivery_name_collision USING btree (collision_type, colliding_name, area_slug);


--
-- Name: delivery_origin_active_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_origin_active_idx ON public.delivery_origin USING btree (active);


--
-- Name: delivery_pricing_policy_singleton_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_pricing_policy_singleton_idx ON public.delivery_pricing_policy USING btree (singleton);


--
-- Name: delivery_quote_capture_area_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_quote_capture_area_idx ON public.delivery_quote_capture USING btree (area_slug);


--
-- Name: delivery_quote_capture_delivered_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX delivery_quote_capture_delivered_idx ON public.delivery_quote_capture USING btree (delivered_at);


--
-- Name: delivery_quote_capture_order_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX delivery_quote_capture_order_uq ON public.delivery_quote_capture USING btree (order_id);
...
--
-- Name: dest_cred_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX dest_cred_idx ON public.measurement_destination_credentials USING btree (destination_key, credential_key);
...
--
-- Name: devices_popularity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX devices_popularity_idx ON public.devices USING btree (popularity_rank_ug);


--
-- Name: devices_slug_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX devices_slug_idx ON public.devices USING btree (slug);
...
--
-- Name: external_delivery_readiness_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX external_delivery_readiness_status_idx ON public.external_delivery_readiness_records USING btree (status);


--
-- Name: flash_sale_items_sale_product_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX flash_sale_items_sale_product_idx ON public.flash_sale_items USING btree (flash_sale_id, product_id);


--
-- Name: flash_sale_reservations_expiry_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX flash_sale_reservations_expiry_idx ON public.flash_sale_reservations USING btree (status, expires_at);


--
-- Name: flash_sale_reservations_idempotency_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX flash_sale_reservations_idempotency_idx ON public.flash_sale_reservations USING btree (idempotency_key);


--
-- Name: flash_sale_reservations_item_customer_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX flash_sale_reservations_item_customer_idx ON public.flash_sale_reservations USING btree (flash_sale_item_id, customer_identity_hash, status);


--
-- Name: flash_sale_reservations_token_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX flash_sale_reservations_token_idx ON public.flash_sale_reservations USING btree (reservation_token);


--
-- Name: flash_sales_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX flash_sales_status_idx ON public.flash_sales USING btree (status, starts_at);
...
--
-- Name: gamification_badges_key_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX gamification_badges_key_uq ON public.gamification_badges USING btree (key);


--
-- Name: gamification_missions_key_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX gamification_missions_key_uq ON public.gamification_missions USING btree (key);


--
-- Name: gsc_performance_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX gsc_performance_date_idx ON public.gsc_performance USING btree (date);


--
-- Name: gsc_performance_date_page_query_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX gsc_performance_date_page_query_idx ON public.gsc_performance USING btree (date, page, query);


--
-- Name: gsc_performance_page_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX gsc_performance_page_date_idx ON public.gsc_performance USING btree (page, date);
...
--
-- Name: legal_policies_key_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX legal_policies_key_uq ON public.legal_policies USING btree (key);


--
-- Name: legal_policy_versions_policy_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX legal_policy_versions_policy_idx ON public.legal_policy_versions USING btree (policy_id);


--
-- Name: legal_policy_versions_policy_version_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX legal_policy_versions_policy_version_uq ON public.legal_policy_versions USING btree (policy_id, version);


--
-- Name: legal_policy_versions_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX legal_policy_versions_status_idx ON public.legal_policy_versions USING btree (status);
...
--
-- Name: loyalty_config_singleton_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_config_singleton_idx ON public.loyalty_config USING btree (singleton);


--
-- Name: loyalty_daily_control_totals_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_daily_control_totals_date_idx ON public.loyalty_daily_control_totals USING btree (business_date);


--
-- Name: loyalty_draw_campaigns_code_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_draw_campaigns_code_uq ON public.loyalty_draw_campaigns USING btree (code);


--
-- Name: loyalty_draw_compliance_singleton_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_draw_compliance_singleton_uq ON public.loyalty_draw_compliance USING btree (singleton);


--
-- Name: loyalty_draw_prizes_campaign_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX loyalty_draw_prizes_campaign_idx ON public.loyalty_draw_prizes USING btree (campaign_id);


--
-- Name: loyalty_draw_results_token_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_draw_results_token_uq ON public.loyalty_draw_results USING btree (token_id);


--
-- Name: loyalty_draw_results_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX loyalty_draw_results_user_idx ON public.loyalty_draw_results USING btree (user_id);


--
-- Name: loyalty_draw_tokens_source_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_draw_tokens_source_uq ON public.loyalty_draw_tokens USING btree (campaign_id, source_type, source_id);


--
-- Name: loyalty_draw_tokens_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX loyalty_draw_tokens_user_idx ON public.loyalty_draw_tokens USING btree (user_id, status);


--
-- Name: loyalty_expiry_notices_once_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_expiry_notices_once_idx ON public.loyalty_expiry_notices USING btree (earn_entry_id, notice_kind);


--
-- Name: loyalty_fraud_signals_account_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX loyalty_fraud_signals_account_idx ON public.loyalty_fraud_signals USING btree (account_id);
...
--
-- Name: loyalty_liability_snapshot_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_liability_snapshot_date_idx ON public.loyalty_liability_snapshots USING btree (snapshot_date);


--
-- Name: loyalty_redemptions_idem_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_redemptions_idem_idx ON public.loyalty_redemptions USING btree (idempotency_key);


--
-- Name: loyalty_redemptions_order_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: loyalty_redemptions_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX loyalty_redemptions_status_idx ON public.loyalty_redemptions USING btree (status);


--
-- Name: loyalty_referrals_referee_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_referrals_referee_uq ON public.loyalty_referrals USING btree (referee_user_id);


--
-- Name: loyalty_referrals_referrer_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX loyalty_referrals_referrer_idx ON public.loyalty_referrals USING btree (referrer_user_id);


--
-- Name: loyalty_rules_code_version_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX loyalty_rules_code_version_idx ON public.loyalty_rules USING btree (rule_code, version);


--
-- Name: measurement_gtm_plans_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX measurement_gtm_plans_created_idx ON public.measurement_gtm_plans USING btree (created_at DESC);


--
-- Name: media_asset_variants_asset_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX media_asset_variants_asset_idx ON public.media_asset_variants USING btree (asset_id);


--
-- Name: media_asset_variants_purpose_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX media_asset_variants_purpose_uq ON public.media_asset_variants USING btree (asset_id, purpose, format);


--
-- Name: media_assets_checksum_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX media_assets_checksum_uq ON public.media_assets USING btree (checksum_sha256);
...
CREATE INDEX media_assets_created_idx ON public.media_assets USING btree (created_at);
...
CREATE INDEX media_usages_asset_idx ON public.media_usages USING btree (asset_id);


--
-- Name: media_usages_entity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX media_usages_entity_idx ON public.media_usages USING btree (entity, entity_id);


--
-- Name: media_usages_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX media_usages_uq ON public.media_usages USING btree (asset_id, entity, entity_id, field);
...
--
-- Name: notification_template_overrides_key_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX notification_template_overrides_key_idx ON public.notification_template_overrides USING btree (template_key);


--
-- Name: notification_template_overrides_key_status_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX notification_template_overrides_key_status_uq ON public.notification_template_overrides USING btree (template_key, status);
...
--
-- Name: order_events_order_occurred_idx; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX orders_reservation_state_idx ON public.orders USING btree (reservation_state);
...
--
-- Name: outbox_events_claimable_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX outbox_events_claimable_idx ON public.outbox_events USING btree (next_attempt_at) WHERE (is_processed = false);


--
-- Name: outbox_events_dead_letter_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX outbox_events_dead_letter_idx ON public.outbox_events USING btree (dead_lettered_at DESC) WHERE ((status)::text = 'dead_letter'::text);
...
--
-- Name: outbox_events_lease_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX outbox_events_lease_idx ON public.outbox_events USING btree (lease_expires_at) WHERE ((status)::text = 'processing'::text);
...
--
-- Name: payments_requires_review_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payments_requires_review_idx ON public.payments USING btree (created_at DESC) WHERE (requires_review = true);
...
--
-- Name: phone_verification_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX phone_verification_user_idx ON public.phone_verification_codes USING btree (user_id);
...
--
-- Name: product_device_compat_device_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX product_device_compat_device_idx ON public.product_device_compatibility USING btree (device_id);
...
CREATE UNIQUE INDEX redirects_from_path_idx ON public.redirects USING btree (from_path);


--
-- Name: review_media_review_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX review_media_review_idx ON public.review_media USING btree (review_id, display_order);


--
-- Name: reviews_identity_product_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX reviews_identity_product_uq ON public.reviews USING btree (product_id, customer_identity_hash);


--
-- Name: reviews_order_item_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX reviews_order_item_uq ON public.reviews USING btree (order_item_id) WHERE (order_item_id IS NOT NULL);


--
-- Name: reviews_product_status_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX reviews_product_status_created_idx ON public.reviews USING btree (product_id, status, created_at);


--
-- Name: role_grant_requests_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX role_grant_requests_status_idx ON public.role_grant_requests USING btree (status);


--
-- Name: role_grant_requests_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX role_grant_requests_user_idx ON public.role_grant_requests USING btree (user_id);
...
--
-- Name: ug_area_alias_norm_area_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ug_area_alias_norm_area_idx ON public.ug_area_alias USING btree (normalised_alias, area_slug);


--
-- Name: ug_area_alias_norm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_area_alias_norm_idx ON public.ug_area_alias USING btree (normalised_alias);


--
-- Name: ug_area_alias_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_area_alias_trgm_idx ON public.ug_area_alias USING gin (normalised_alias public.gin_trgm_ops);


--
-- Name: ug_area_district_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_area_district_idx ON public.ug_area USING btree (current_district);


--
-- Name: ug_area_group_member_pair_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ug_area_group_member_pair_idx ON public.ug_area_group_member USING btree (group_id, area_slug);


--
-- Name: ug_area_group_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ug_area_group_name_idx ON public.ug_area_group USING btree (normalised_name, district);


--
-- Name: ug_area_postcode_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_area_postcode_idx ON public.ug_area USING btree (postcode);


--
-- Name: ug_area_search_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_area_search_trgm_idx ON public.ug_area USING gin (search_text public.gin_trgm_ops);


--
-- Name: ug_area_zone_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_area_zone_idx ON public.ug_area USING btree (delivery_zone_code);


--
-- Name: ug_landmark_area_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_landmark_area_idx ON public.ug_landmark USING btree (area_slug);


--
-- Name: ug_landmark_area_name_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ug_landmark_area_name_idx ON public.ug_landmark USING btree (area_slug, lower((name)::text));


--
-- Name: ug_pickup_point_area_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_pickup_point_area_idx ON public.ug_pickup_point USING btree (area_slug);


--
-- Name: ug_pickup_point_carrier_town_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_pickup_point_carrier_town_idx ON public.ug_pickup_point USING btree (carrier, town);


--
-- Name: ug_search_miss_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ug_search_miss_created_idx ON public.ug_search_miss USING btree (created_at);


--
-- Name: ug_search_miss_norm_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_mfa_recovery_code_hash_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX user_mfa_recovery_code_hash_uq ON public.user_mfa_recovery_codes USING btree (code_hash);


--
-- Name: user_mfa_recovery_codes_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_mfa_recovery_codes_user_idx ON public.user_mfa_recovery_codes USING btree (user_id) WHERE (used_at IS NULL);
...
--
-- Name: verification_attempts_user_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX verification_attempts_user_idx ON public.verification_attempts USING btree (user_id);
...
CREATE TRIGGER audit_logs_immutable BEFORE DELETE OR UPDATE ON public.audit_logs FOR EACH ROW EXECUTE FUNCTION public.audit_logs_reject_mutation();
...
--
-- Name: loyalty_daily_control_totals loyalty_daily_control_totals_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER loyalty_daily_control_totals_immutable BEFORE DELETE OR UPDATE ON public.loyalty_daily_control_totals FOR EACH ROW EXECUTE FUNCTION public.loyalty_control_totals_reject_mutation();


--
-- Name: loyalty_ledger_entries loyalty_ledger_entries_immutable; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER loyalty_ledger_entries_immutable BEFORE DELETE OR UPDATE ON public.loyalty_ledger_entries FOR EACH ROW EXECUTE FUNCTION public.loyalty_ledger_reject_mutation();
...
--
-- Name: auth_identity_links auth_identity_links_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.auth_identity_links
    ADD CONSTRAINT auth_identity_links_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: campaign_send_decisions campaign_send_decisions_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.campaign_send_decisions
    ADD CONSTRAINT campaign_send_decisions_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.campaign_send_runs(id) ON DELETE CASCADE;


--
-- Name: campaign_send_runs campaign_send_runs_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.campaign_send_runs
    ADD CONSTRAINT campaign_send_runs_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.campaigns(id) ON DELETE CASCADE;
...
--
-- Name: coupon_codes coupon_codes_promotion_definition_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coupon_codes
    ADD CONSTRAINT coupon_codes_promotion_definition_id_fkey FOREIGN KEY (promotion_definition_id) REFERENCES public.promotion_definitions(id);
...
ALTER TABLE ONLY public.coupon_redemptions
    ADD CONSTRAINT coupon_redemptions_coupon_id_fkey FOREIGN KEY (coupon_id) REFERENCES public.coupon_codes(id);
...
--
-- Name: creator_attributions creator_attributions_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_attributions
    ADD CONSTRAINT creator_attributions_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.creators(id);


--
-- Name: creator_attributions creator_attributions_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_attributions
    ADD CONSTRAINT creator_attributions_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id);


--
-- Name: creator_commissions creator_commissions_contract_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_commissions
    ADD CONSTRAINT creator_commissions_contract_id_fkey FOREIGN KEY (contract_id) REFERENCES public.creator_contracts(id);


--
-- Name: creator_commissions creator_commissions_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_commissions
    ADD CONSTRAINT creator_commissions_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.creators(id);


--
-- Name: creator_commissions creator_commissions_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_commissions
    ADD CONSTRAINT creator_commissions_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id);


--
-- Name: creator_content_assets creator_content_assets_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_content_assets
    ADD CONSTRAINT creator_content_assets_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.creators(id);


--
-- Name: creator_contracts creator_contracts_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_contracts
    ADD CONSTRAINT creator_contracts_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.creators(id);


--
-- Name: creator_link_clicks creator_link_clicks_link_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_link_clicks
    ADD CONSTRAINT creator_link_clicks_link_id_fkey FOREIGN KEY (link_id) REFERENCES public.creator_links(id);


--
-- Name: creator_links creator_links_creator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.creator_links
    ADD CONSTRAINT creator_links_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.creators(id);
...
ALTER TABLE ONLY public.creator_payouts
    ADD CONSTRAINT creator_payouts_creator_id_fkey FOREIGN KEY (creator_id) REFERENCES public.creators(id);


--
-- Name: customer_badges customer_badges_badge_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_badges
    ADD CONSTRAINT customer_badges_badge_id_fkey FOREIGN KEY (badge_id) REFERENCES public.gamification_badges(id) ON DELETE CASCADE;
...
--
-- Name: delivery_config_value delivery_config_value_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.delivery_config_value
    ADD CONSTRAINT delivery_config_value_version_id_fkey FOREIGN KEY (version_id) REFERENCES public.delivery_config_version(id) ON DELETE CASCADE;
...
--
-- Name: flash_sale_reservations flash_sale_reservations_flash_sale_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flash_sale_reservations
    ADD CONSTRAINT flash_sale_reservations_flash_sale_item_id_fkey FOREIGN KEY (flash_sale_item_id) REFERENCES public.flash_sale_items(id);


--
-- Name: flash_sales flash_sales_promotion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.flash_sales
    ADD CONSTRAINT flash_sales_promotion_id_fkey FOREIGN KEY (promotion_id) REFERENCES public.promotion_definitions(id);
...
--
-- Name: gamification_badges gamification_badges_mission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gamification_badges
    ADD CONSTRAINT gamification_badges_mission_id_fkey FOREIGN KEY (mission_id) REFERENCES public.gamification_missions(id) ON DELETE SET NULL;


--
-- Name: gsc_performance gsc_performance_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legal_policy_versions legal_policy_versions_policy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.legal_policy_versions
    ADD CONSTRAINT legal_policy_versions_policy_id_fkey FOREIGN KEY (policy_id) REFERENCES public.legal_policies(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.loyalty_accounts
    ADD CONSTRAINT loyalty_accounts_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE RESTRICT;


--
-- Name: loyalty_draw_prizes loyalty_draw_prizes_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_prizes
    ADD CONSTRAINT loyalty_draw_prizes_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.loyalty_draw_campaigns(id) ON DELETE RESTRICT;


--
-- Name: loyalty_draw_results loyalty_draw_results_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_results
    ADD CONSTRAINT loyalty_draw_results_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.loyalty_draw_campaigns(id) ON DELETE RESTRICT;


--
-- Name: loyalty_draw_results loyalty_draw_results_prize_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_results
    ADD CONSTRAINT loyalty_draw_results_prize_id_fkey FOREIGN KEY (prize_id) REFERENCES public.loyalty_draw_prizes(id) ON DELETE RESTRICT;


--
-- Name: loyalty_draw_results loyalty_draw_results_token_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_results
    ADD CONSTRAINT loyalty_draw_results_token_id_fkey FOREIGN KEY (token_id) REFERENCES public.loyalty_draw_tokens(id) ON DELETE RESTRICT;


--
-- Name: loyalty_draw_tokens loyalty_draw_tokens_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_draw_tokens
    ADD CONSTRAINT loyalty_draw_tokens_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.loyalty_draw_campaigns(id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.loyalty_ledger_entries
    ADD CONSTRAINT loyalty_ledger_entries_account_id_loyalty_accounts_id_fk FOREIGN KEY (account_id) REFERENCES public.loyalty_accounts(id) ON DELETE RESTRICT;
...
--
-- Name: loyalty_redemptions loyalty_redemptions_account_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.loyalty_redemptions
    ADD CONSTRAINT loyalty_redemptions_account_fk FOREIGN KEY (account_id) REFERENCES public.loyalty_accounts(id) ON DELETE RESTRICT;
...
--
-- Name: measurement_destination_credentials measurement_destination_credentials_destination_id_measurement_; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_destination_credentials
    ADD CONSTRAINT measurement_destination_credentials_destination_id_measurement_ FOREIGN KEY (destination_id) REFERENCES public.measurement_paid_social_destinations(id);
...
--
-- Name: media_asset_variants media_asset_variants_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.media_asset_variants
    ADD CONSTRAINT media_asset_variants_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.media_assets(id) ON DELETE CASCADE;


--
-- Name: media_usages media_usages_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.media_usages
    ADD CONSTRAINT media_usages_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.media_assets(id) ON DELETE CASCADE;
...
--
-- Name: product_device_compatibility product_device_compatibility_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_device_compatibility
    ADD CONSTRAINT product_device_compatibility_device_id_fkey FOREIGN KEY (device_id) REFERENCES public.devices(id);
...
ALTER TABLE ONLY public.product_device_compatibility
    ADD CONSTRAINT product_device_compatibility_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id);
...
--
-- Name: product_images product_images_asset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_images
    ADD CONSTRAINT product_images_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.media_assets(id) ON DELETE SET NULL;
...
--
-- Name: product_rating_aggregate product_rating_aggregate_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_rating_aggregate
    ADD CONSTRAINT product_rating_aggregate_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id);
...
ALTER TABLE ONLY public.review_media
    ADD CONSTRAINT review_media_review_id_fkey FOREIGN KEY (review_id) REFERENCES public.reviews(id);
...
--
-- Name: ug_area_alias ug_area_alias_area_slug_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_area_alias
    ADD CONSTRAINT ug_area_alias_area_slug_fk FOREIGN KEY (area_slug) REFERENCES public.ug_area(area_slug);


--
-- Name: ug_area_group_member ug_area_group_member_area_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_area_group_member
    ADD CONSTRAINT ug_area_group_member_area_fk FOREIGN KEY (area_slug) REFERENCES public.ug_area(area_slug);


--
-- Name: ug_area_group_member ug_area_group_member_group_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_area_group_member
    ADD CONSTRAINT ug_area_group_member_group_fk FOREIGN KEY (group_id) REFERENCES public.ug_area_group(id);


--
-- Name: ug_landmark ug_landmark_area_slug_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_landmark
    ADD CONSTRAINT ug_landmark_area_slug_fk FOREIGN KEY (area_slug) REFERENCES public.ug_area(area_slug);


--
-- Name: ug_pickup_point ug_pickup_point_area_slug_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ug_pickup_point
    ADD CONSTRAINT ug_pickup_point_area_slug_fk FOREIGN KEY (area_slug) REFERENCES public.ug_area(area_slug);
